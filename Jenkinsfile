// Jenkinsfile
//
// clickkart-notification-service's own copy of Jenkinsfile.template (Section 5: "no shared
// Jenkins library - copy this file into each service's own repo root"). Only
// SERVICE_NAME/SERVICE_PORT differ from the template; everything else is identical by design.
...
pipeline {
    ...
    environment {
        SERVICE_NAME   = 'clickkart-notification-service'
        SERVICE_PORT   = '8082'
